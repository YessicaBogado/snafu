...
class SnafuControl:
    ...
    @app.route(
        "/v1beta2/projects/<project>/locations/<location>/functions/<function>", methods=["POST"])
    ...
    def funcHub():
        ...
        try:
            json_data = open("/home/snafu/listFun").read()
    ...
    def createfunction():
        ...
        # snafulib.snafu.SnafuImport.prepare()
        snafulib.snafu.SnafuImport.importfunction(functionname, codezip,
                                                  config, convert=True)

        SnafuControl.snafu.activate([snafulib.snafu.SnafuImport.functiondir],
                                    "lambda")
    ...
    @app.route("/functions/<function>", methods=["GET", "DELETE"])
    ...
    @app.route("/functions/<function>/code", methods=["PUT"])
    ...
    @app.route("/functions/<function>/configuration", methods=["GET", "PUT"])
    ...
    @app.route("/functions/<function>/policy", methods=["POST"])
    ...
    @app.route("/functions/<function>/invocations", methods=["POST"])
    def invoke(function):
        auth = SnafuControl.authorise()
        if not auth:
            return ControlUtil.notauthorised()
